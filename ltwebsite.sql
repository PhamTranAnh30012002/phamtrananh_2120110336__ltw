...
--
-- Host: localhost:3306
-- Generation Time: Nov 16, 2023 at 05:59 AM
...
--
-- Table structure for table `0336_banner`
--

CREATE TABLE `0336_banner` (
...
--
-- Dumping data for table `0336_banner`
--

INSERT INTO `0336_banner` (`id`, `name`, `link`, `position`, `image`, `sort_order`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0336_brand`
--

CREATE TABLE `0336_brand` (
...
--
-- Dumping data for table `0336_brand`
--

INSERT INTO `0336_brand` (`id`, `name`, `slug`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
(4, 'Nhật Bản', 'nhat-ban', 0, '', 'Từ khóa SEO', '2023-10-28 19:59:05', 1, '2022-11-19 00:54:44', 1, 1),
...
(15, 'sdfdsfsdfdsfds loi', 'sdfdsfsdfdsfds-loi', 1, 'sdfdsfsdfdsfds-loi.png', 'dsfsdfdsfdsfdsf', '2023-10-28 19:59:06', 1, '2023-07-30 16:07:00', 1, 1),
(17, 'qưdqwdqwd', '', 1, '20231029025921.jpg', 'qưdqwdqwd', '2023-10-28 19:59:21', 1, NULL, NULL, 1),
(18, 'CAM', '', 1, '20231029030019.jpg', 'CAM', '2023-10-28 20:00:19', 1, NULL, NULL, 1),
(19, 'THAI', '', 1, '20231029030122.png', 'THAI', '2023-10-28 20:01:22', 1, NULL, NULL, 1),
(20, 'DQWDQW', '', 1, '20231029030143.png', 'DQWDQW', '2023-10-28 20:01:43', 1, NULL, NULL, 1),
(21, 'hffgd', '222', 1, '222.png', 'gfvfgfv', '2023-11-15 20:59:45', 1, '2023-11-15 21:01:08', 1, 2);

-- --------------------------------------------------------

--
-- Table structure for table `0336_category`
--

CREATE TABLE `0336_category` (
  `id` int NOT NULL COMMENT 'Mã Loại',
  `name` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'Tên loại SP',
  `slug` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_unicode_ci NOT NULL COMMENT 'SLug Loại SP',
...
--
-- Dumping data for table `0336_category`
--

INSERT INTO `0336_category` (`id`, `name`, `slug`, `parent_id`, `sort_order`, `image`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
--
-- Table structure for table `0336_contact`
--

CREATE TABLE `0336_contact` (
...
--
-- Dumping data for table `0336_contact`
--

INSERT INTO `0336_contact` (`id`, `name`, `email`, `phone`, `title`, `content`, `replay_id`, `created_at`, `updated_at`, `updated_by`, `status`) VALUES
(8, 'ghghgn', 'gfghhng', '09897897878', 'ghngh', 'hvvhbv', 676, '2023-11-15 21:20:57', '2023-11-15 21:21:23', 1, 0);

-- --------------------------------------------------------

--
-- Table structure for table `0336_menu`
--

CREATE TABLE `0336_menu` (
...
--
-- Dumping data for table `0336_menu`
--

INSERT INTO `0336_menu` (`id`, `name`, `link`, `type`, `table_id`, `sort_order`, `position`, `level`, `parent_id`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
(1, 'Trang chủ', 'http://localhost/PHP/PhamTranAnh/', 'custom', 0, 2, 'mainmenu', 1, 0, '2022-11-22 05:36:05', 1, '2023-07-31 23:17:16', 1, 1),
...
(25, 'Quần short nữ', 'index.php?option=product&cat=quan-short-nu', 'category', 10, 1, 'mainmenu', 1, 0, '2023-08-17 05:53:49', 1, '2023-11-15 21:16:58', 1, 0),
(26, 'Áo kiểu', 'index.php?option=product&cat=ao-kieu', 'category', 9, 1, 'mainmenu', 1, 0, '2023-08-17 05:53:49', 1, '2023-11-15 21:17:10', 1, 2),
...
--
-- Table structure for table `0336_order`
--

CREATE TABLE `0336_order` (
...
--
-- Dumping data for table `0336_order`
--

INSERT INTO `0336_order` (`id`, `user_id`, `deliveryaddress`, `deliveryname`, `deliveryphone`, `deliveryemail`, `note`, `created_at`, `updated_at`, `updated_by`, `status`) VALUES
(14, 6, 'Bình Dương', 'Trần Anh', '098888', 'hodienloi@gmail.com', 'Không chú ý', '2023-11-04 20:50:12', '2023-11-04 20:50:12', NULL, 1),
(15, 6, 'Bình Dương', 'Trần Anh', '098888', 'hodienloi@gmail.com', 'Không chú ý', '2023-11-04 20:55:48', '2023-11-04 20:55:48', NULL, 1);

-- --------------------------------------------------------

--
-- Table structure for table `0336_orderdetail`
--

CREATE TABLE `0336_orderdetail` (
...
--
-- Dumping data for table `0336_orderdetail`
--

INSERT INTO `0336_orderdetail` (`id`, `order_id`, `product_id`, `price`, `qty`, `amount`) VALUES
(7, 14, 16, 10000.00, 1, 10000.00),
(8, 15, 16, 10000.00, 1, 10000.00);

-- --------------------------------------------------------

--
-- Table structure for table `0336_post`
--

CREATE TABLE `0336_post` (
...
--
-- Dumping data for table `0336_post`
--

INSERT INTO `0336_post` (`id`, `topic_id`, `title`, `slug`, `detail`, `image`, `type`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
(40, 4, 'hffhjgghgnb', 'jggjhbn', 'ghgh', 'jggjhbn.png', 'jhhjhjhj', 'nbhnbnbnb', '2023-11-15 21:12:52', 1, '2023-11-15 21:13:40', 1, 2);

-- --------------------------------------------------------

--
-- Table structure for table `0336_product`
--

CREATE TABLE `0336_product` (
...
--
-- Dumping data for table `0336_product`
--

INSERT INTO `0336_product` (`id`, `category_id`, `brand_id`, `name`, `slug`, `image`, `detail`, `qty`, `price`, `pricesale`, `description`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
...
(36, 12, 1, 'CHÂN VÁY W2CNV06201FOSCR', 'chan-vay-w2cnv06201foscr', 'chan-vay-w2cnv06201foscr.jpg', '<h1>CH&Acirc;N V&Aacute;Y W2CNV06201FOSCR</h1>\r\n', 1, 10000.00, 10000.000, 'CHÂN VÁY W2CNV06201FOSCR', '2022-11-22 05:42:21', 1, '2023-11-04 18:28:19', 1, 2);

-- --------------------------------------------------------

--
-- Table structure for table `0336_topic`
--

CREATE TABLE `0336_topic` (
...
--
-- Dumping data for table `0336_topic`
--

INSERT INTO `0336_topic` (`id`, `name`, `slug`, `parent_id`, `sort_order`, `metakey`, `metadesc`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
(4, 'fgfgh', 'ghgh', 0, 1, 'ghg', 'ghghghg', '2023-11-15 21:12:01', 1, '2023-11-15 21:12:01', 1, 2);

-- --------------------------------------------------------

--
-- Table structure for table `0336_user`
--

CREATE TABLE `0336_user` (
...
--
-- Dumping data for table `0336_user`
--

INSERT INTO `0336_user` (`id`, `name`, `username`, `password`, `email`, `gender`, `phone`, `image`, `roles`, `address`, `created_at`, `created_by`, `updated_at`, `updated_by`, `status`) VALUES
(6, 'Trần Anh', 'admin', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'hodienloi@gmail.com', 1, '098888', 'hodienloi.jpg', 1, 'Bình Dương', '2023-10-13 10:34:44', 1, '2023-11-15 21:19:55', 1, 2);
...
--
-- Indexes for table `0336_banner`
--
ALTER TABLE `0336_banner`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_brand`
--
ALTER TABLE `0336_brand`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_category`
--
ALTER TABLE `0336_category`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_contact`
--
ALTER TABLE `0336_contact`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_menu`
--
ALTER TABLE `0336_menu`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_order`
--
ALTER TABLE `0336_order`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_orderdetail`
--
ALTER TABLE `0336_orderdetail`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_post`
--
ALTER TABLE `0336_post`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_product`
--
ALTER TABLE `0336_product`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_topic`
--
ALTER TABLE `0336_topic`
  ADD PRIMARY KEY (`id`) USING BTREE;

--
-- Indexes for table `0336_user`
--
ALTER TABLE `0336_user`
  ADD PRIMARY KEY (`id`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `0336_banner`
--
ALTER TABLE `0336_banner`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã Slider', AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `0336_brand`
--
ALTER TABLE `0336_brand`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'Mã Loại', AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `0336_category`
--
ALTER TABLE `0336_category`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'Mã Loại', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `0336_contact`
--
ALTER TABLE `0336_contact`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'Mã liên hệ', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `0336_menu`
--
ALTER TABLE `0336_menu`
  MODIFY `id` int NOT NULL AUTO_INCREMENT COMMENT 'Mã Menu', AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `0336_order`
--
ALTER TABLE `0336_order`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã đơn hàng', AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT for table `0336_orderdetail`
--
ALTER TABLE `0336_orderdetail`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã CT Đơn hàng', AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `0336_post`
--
ALTER TABLE `0336_post`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã bài viết', AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT for table `0336_product`
--
ALTER TABLE `0336_product`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã sản phẩm', AUTO_INCREMENT=37;

--
-- AUTO_INCREMENT for table `0336_topic`
--
ALTER TABLE `0336_topic`
  MODIFY `id` int UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Mã chủ đề', AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `0336_user`
--
ALTER TABLE `0336_user`
